...
class IMPORT_OT_gcode(bpy.types.Operator):
    ...
    def parse(self, fileName):
        ...
        scn = bpy.context
        scn.scene.collection.objects.link(profileObject)
        scn.view_layer.objects.active = profileObject
        ...
        for layerNum,layer in enumerate(self.layers):
            ...
            scn.scene.collection.objects.link(layerObject)
            scn.view_layer.objects.active = layerObject
